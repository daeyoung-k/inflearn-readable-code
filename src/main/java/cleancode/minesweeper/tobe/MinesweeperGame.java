...
public class MinesweeperGame {
    ...
    public static void main(String[] args) {
        ...
        for (int row = 0; row < 8; row++) {
            for (int col = 0; col < 10; col++) {
                ...
                if (!landMines[row][col]) {
                    ...
                    if (row - 1 >= 0 && row + 1 < 10 && landMines[row - 1][col + 1]) {
                        count++;
                    }
                    if (row - 1 >= 0 && landMines[row][col - 1]) {
                        count++;
                    }
        ...
        while (true) {
            ...
            String userActionCol = scanner.nextLine();
            ...
            } else if (userActionCol.equals("1")) {
